...
st.caption("Bubble = population | Colour = continent (categorical)")
...
# COLOUR TYPE: categorical — continent is an unordered group
fig = px.scatter(
    df_y, x='gdpPercap', y='lifeExp', size='pop', color='continent',
